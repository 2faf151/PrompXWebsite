...
export default function AboutUs() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <p className="text-lg leading-7 text-gray-700 mb-4">
        Our goal is ambitious: we aim to become the Visual Studio Code of data analytics—a universally accessible, elegantly simple, and endlessly extensible environment for analysts, developers, and businesses alike. We are committed to creating an ecosystem where anyone can effortlessly set up sophisticated agentic workflows, run rapid analyses, and build interactive dashboards—all within a familiar and beautiful workspace.
      </p>
